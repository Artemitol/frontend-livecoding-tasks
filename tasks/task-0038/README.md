# task-0038 — Типизированный выбор полей объекта
...
// Верните новый объект и не изменяйте source; для примера результат равен {"a":1,"c":true}, selected !== source и исходный JSON сохраняется.
// Не используйте дополнительные библиотеки.
