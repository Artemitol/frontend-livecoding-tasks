# task-0037 — Стоимость проживания по дням недели
...
// Для двух примеров и проверки исходной даты выведите 11900, 5900 и true.
...
Копия даты движется от ночи заселения до последней оплачиваемой ночи. Исходный объект `Date` не меняется, а явные UTC-примеры не зависят от локального часового пояса.
