# task-0046 — Выдача купюр с ограниченным запасом
...
// При равном числе купюр предпочитайте вариант с большим количеством старших номиналов; не изменяйте stock и сравните три сценария с примерами.
