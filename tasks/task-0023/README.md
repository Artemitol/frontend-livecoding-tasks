...
Executor и основной стек завершаются до microtask. Timer на 100 мс первым ставит вложенную работу на 1000 мс; `finally` создаёт второй такой timer только после завершения цепочки на 500 мс.
